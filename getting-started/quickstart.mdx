...
This starts the web dashboard at [http://localhost:4700](http://localhost:4700) and opens your browser automatically. The dashboard is where you run all development phases: edit the constitution, review architecture, create tasks, and step through clarify → plan → implement → review.
...
- **Work on tasks** — each task goes through Clarify → Plan → Implement → Review
