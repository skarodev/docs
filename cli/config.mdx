...
For role-based routing, verify commands, import settings, and other advanced options, use the web dashboard or edit `.skaro/config.yaml` directly. See [Role-Based Routing](/providers/role-based-routing) and [Dashboard Configuration](/dashboard/configuration) for details.
